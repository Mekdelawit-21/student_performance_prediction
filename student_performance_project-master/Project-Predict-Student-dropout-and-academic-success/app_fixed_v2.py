...
def train_new_model():
    ...
    try:
        ...
        # Higher chance of dropout based on certain factors
        ...
        # Save the new model
        joblib.dump(model_pipeline, 'my_trained_model_v2.joblib')
...
def load_model():
    ...
    try:
        ...
        if os.path.exists('my_trained_model_v2.joblib'):
            model_pipeline = joblib.load('my_trained_model_v2.joblib')
