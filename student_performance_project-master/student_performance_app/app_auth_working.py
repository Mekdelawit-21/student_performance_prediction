"""
Student Performance App with Simple Authentication - Working Version
Fixed login/signup pages without Clerk dependencies
"""
...
# Simple authentication routes (without Clerk)
@app.route('/login')
def login():
    """Login page"""
...
if __name__ == '__main__':
    print("Starting Student Performance App with Simple Authentication...")
