...
def train_models():
    """Train models for exam performance prediction"""
    global model, scaler
...
def predict():
    try:
        ...
        assignment_score = float(data.get('assignmentScore', 70))
        ...
        result = {
            ...
            'grade': grade,
            'performance': 'Excellent' if predicted_score >= 80 else 'Good' if predicted_score >= 70 else 'Average' if predicted_score >= 60 else 'Poor'
        }
